...
public class Account extends IdentifiableEntity{
     ...
     * @param amount
     * @param ssn
     * @throws InsufficinetBalanceException
     * @throws SsnNotValideException
     * @throws NegativeAmountException
     */
    public void withdraw (double amount, String ssn)
        ...
        try {
            ...
            if (amount > balance) throw new InsufficinetBalanceException(getBalance(), amount);
            if (!isSsnValid(ssn)) throw new SsnNotValideException(ssn);

            balance -= amount;

        } catch (InsufficinetBalanceException | SsnNotValideException | NegativeAmountException e){
